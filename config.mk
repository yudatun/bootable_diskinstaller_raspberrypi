...
INTERNAL_RPI_BOOTIMAGE_FILES := $(filter $(TARGET_ROOT_OUT)/%, \
    $(ALL_PREBUILT) \
...
TARGET_BOOTIMAGE_SIZE := $(strip $(TARGET_BOOTIMAGE_SIZE))
ifdef TARGET_BOOTIMAGE_SIZE
  INTERNAL_BOOTIMAGE_ARGS += --size=$(TARGET_BOOTIMAGE_SIZE)
endif
...
define build-rpi-bootimage-target
    ...
    $(hide) PATH=$(foreach p,$(INTERNAL_RPI_BOOTIMAGE_BINARY_PATHS),$(p):)$$PATH
      ...
      $(INTERNAL_RPI_BOOTIMAGE_ARGS) $(TARGET_ROOT_OUT) $(1)
endef
